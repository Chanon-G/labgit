...
while True:
    ...
    if(len(Blob.getContours())>=1):
        cv.drawContours(contours_img, Blob.getContours(), -1, (255,255,0)) 
    ...
    cv.putText(frame, 'Counting Zone', (50, y_startCount+30), cv.FONT_HERSHEY_SIMPLEX, 1 ,(0,255,255), 2),cv.putText(contours_img, 'Counting Zone', (50, y_startCount+30), cv.FONT_HERSHEY_SIMPLEX, 1 ,(255,255,255), 2)
    cv.line(frame,(0,y_startCount),(fWidth,y_startCount),(0,50,255),2),    cv.line(frame,(0,y_endCount),(fWidth,y_endCount),(0,50,255),2)
    cv.line(contours_img,(0,y_startCount),(fWidth,y_startCount),(0,50,255),2),    cv.line(contours_img,(0,y_endCount),(fWidth,y_endCount),(0,50,255),2)
